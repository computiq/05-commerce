...
from commerce.schemas import AddressIn, AddressesOut, ProductOut, CitiesOut, CitySchema, VendorOut, ItemOut, ItemSchema, ItemCreate, CheckOut
...
def checkout_create(request, check_out: CheckOut):
    checkout_obj = get_object_or_404(Order, user=request.auth['pk'], ordered = False)
